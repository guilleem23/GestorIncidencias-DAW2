...
document.addEventListener('DOMContentLoaded', function() {
                    ...
                    .then(data => {
                        if (data.success) {
                            Swal.fire({
                                ...
                                comentarioItem.style.transition = 'opacity 0.3s';
                                ...
                                setTimeout(() => {
                                    ...
                                    // Verificar si no quedan comentarios
                                        ...
                                        // Mostrar mensaje de "sin comentarios"
                                        container.innerHTML = '<div style="margin-top: 0.5rem; color: var(--texto-secundario); font-size: 0.9rem;"><i class="fas fa-comment-dots"></i> Sin comentarios todavía</div>';
                                    }
                                }, 300);
                            });
                        } else {
    ...
    style.textContent = `
        .btn-comment-action-client {
            color: #94a3b8;
        }
        .btn-comment-action-client:hover {
