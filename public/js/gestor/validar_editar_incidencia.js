function iniciarValidacionEditarIncidencia() {
    ...
    function comprobarEstatYTecnico() {
        ...
        // Validación lógica técnico-estado
        if (tecnic !== "" && estat === "Sense assignar") {
            eTecnicEstat.innerText = 'El estado no puede ser "Sense assignar" si hay un técnico asignado.';
        ...
        if (tecnic === "" && estat !== "Sense assignar") {
            eTecnicEstat.innerText = 'Debe asignar un técnico si el estado no es "Sense assignar".';
            eTecnicEstat.style.display = "block";
            comprobarBoton();
            return;
        }
