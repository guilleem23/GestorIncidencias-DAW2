<form action="{{ route('admin.usuarios.update', $usuario->id) }}" method="POST" class="needs-validation" novalidate>
    ...
    <div class="mb-2">
        <label class="form-label" for="edit-password-usuario">Contraseña (dejar en blanco para no cambiar):</label>
    ...
    <button type="submit" id="edit-boton-enviar" class="btn btn-success">Actualizar Usuario</button>
</form>