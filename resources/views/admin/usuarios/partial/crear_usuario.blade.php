    <form method="POST" action="{{ route('admin.usuarios.store') }}" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <div id="error-nombre" class="text-danger small">
                @error('name')
                    {{ $message }}
                @enderror
            </div>
        ...
        <div class="mb-3">
            ...
            <div id="error-email" class="text-danger small">
                @error('email')
                    {{ $message }}
                @enderror
            </div>
        ...
        <div class="mb-3">
            ...
            <div id="error-password" class="text-danger small">
                @error('password')
                    {{ $message }}
                @enderror
            </div>
        ...
        <div class="mb-3">
            ...
            <div id="error-sede_id" class="text-danger small">
                @error('sede_id')
                    {{ $message }}
                @enderror
            </div>
        ...
        <div class="mb-3">
            ...
            <div id="error-rol" class="text-danger small">
                @error('rol')
                    {{ $message }}
                @enderror
            </div>
