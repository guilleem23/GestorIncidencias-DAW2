...
@section('content')
    <div class="container-fluid">
                ...
                <div class="card-header-premium">
                    ...
                    <div style="display: flex; gap: 0.75rem; align-items: center;">
                        @if ($incidencia->prioritat)
                            ...
                            @else
                                <span class="priority-badge priority-baixa"><i class="fa-solid fa-arrow-down"></i>
                                    Baja</span>
                            @endif
                        @endif
                ...
                <div class="card-body-premium">
                        ...
                        <div class="info-block">
                                ...
                                <div class="user-profile-mini">
                                    ...
                                    <div class="user-text-mini">
                                        <a class="user-name-mini"
                                            href="{{ route('gestor.usuarios.show', $incidencia->cliente->id) }}"
                            ...
                            @else
                                <div class="user-profile-mini" style="opacity: 0.6">
                                    <div class="avatar-mini" style="background: #4b5563;"><i
                    ...
                    <div class="description-block" style="margin-top: 1.5rem;">
                        ...
                        <div id="comments-container"
                            ...
                            @if ($incidencia->comentarios && $incidencia->comentarios->count())
                                @foreach ($incidencia->comentarios as $comentario)
                                    @include('gestor.partials.comentario_item', [
                                        'comentario' => $comentario,
                                    ])
                                @endforeach
                            @else
                                <div id="no-comments-msg" class="fade-in-up"
                        ...
                        <form id="form-comentario" method="POST"
                            action="{{ route('gestor.incidencias.comentarios.store', $incidencia->id) }}"
                            enctype="multipart/form-data" style="margin-top: 0.9rem;">
                            @csrf
                            <div style="display:flex; flex-direction:column; gap:0.5rem;">
                                <textarea id="missatge-comentario" name="missatge" rows="3" class="comment-textarea"
                                ...
                                <div class="comment-upload-row">
                                    ...
                                    <input id="imatge-comentario" type="file" name="imatge"
                                        class="comment-file-input" accept="image/*">
                                    <span id="file-name-display"
                                        style="color: var(--text-secondary); font-size: 0.9rem; margin-left: 0.5rem;"></span>
                                </div>
                                @error('imatge')
                                    <span class="error-message" style="margin-top: 0;">
                                        <i class="fa-solid fa-circle-exclamation"></i> {{ $message }}
                                ...
                                <div style="display:flex; justify-content:flex-end;">
                                    <button type="submit" id="btn-submit-comentario" class="btn-primary"
        ...
        @include('gestor.partials.modal_editar_incidencia')

        <!-- Modal Ver Imagen Comentario -->
        @include('gestor.partials.modal_imagen_comentario')

        <!-- Modal Editar Comentario -->
        @include('gestor.partials.modal_editar_comentario')
    </div>
@endsection
