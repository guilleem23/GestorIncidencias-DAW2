            ...
            @foreach ($incidencies as $incidencia)
                <tr class="{{ $incidencia->estat === 'Tancada' ? 'row-closed' : '' }}">
                    ...
                    <td>
                        ...
                        @else
                            <div style="text-align: center;"><span class="text-secondary" title="Sin asignar"><i
                                        class="fa-solid fa-user-minus"></i></span></div>
                        @endif
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="actions-cell">
                            <a href="{{ route('gestor.incidencias.show', $incidencia->id) }}" class="btn-icon btn-view"
                                title="Ver Detalles">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                            <button type="button" id="btn-edit-incidencia-{{ $incidencia->id }}"
                                name="editar_incidencia" class="btn-icon btn-edit btn-editar-incidencia"
                                data-id="{{ $incidencia->id }}" title="Editar incidencia">
